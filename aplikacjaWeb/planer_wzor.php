...
<html lang="en">
  <head>
    ...
    <link href="resources/css/planer.css" rel="stylesheet">
                ...
                <div class="card mb-4 box-shadow">
                  ...
                  <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                      <div class="btn-group">
                        <a  href="planer_twarz.php"><button type="button" class="btn btn-sm btn-outline-secondary">Wybierz</button></a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-md-6">
                <div class="card mb-4 box-shadow">
                  ...
                  <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                      <div class="btn-group">
                        <a href="planer_wlosy.php"><button type="button" class="btn btn-sm btn-outline-secondary">Wybierz</button></a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-md-6">
                <div class="card mb-4 box-shadow">
                  ...
                  <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                      <div class="btn-group">
                        <a href="planer_paznokcie.php"><button type="button" class="btn btn-sm btn-outline-secondary">Wybierz</button></a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-md-6">
                <div class="card mb-4 box-shadow">
                  ...
                  <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                      <div class="btn-group">
                        <a href="planer_cialo.php"><button type="button" class="btn btn-sm btn-outline-secondary">Wybierz</button></a>
                      </div>
                    </div>
                  </div>
                </div>
