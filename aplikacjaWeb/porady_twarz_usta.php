...
<main role="main">
        ...
        <section class="jumbotron text-center">
          <div class="container">
            <h1 class="jumbotron-heading"> Usta  </h1>
            <p class="lead text-muted">Drobne niedoskonałości w rysunku ust można zatuszować makijażem. Lecz by usta były prawdziwym atrybutem kobiecej urody, muszą być gładkie i jędrne. Zobacz, jak dbać o usta, żeby skóra wokół nich była odżywiona i zadbana.</p> 
            <a href="porady.php"><button type="button" class="btn btn-outline-secondary btn-sm">Porady</button></a> &gt; 
                ...
                <a href="porady_twarz_usta.php"><button type="button" class="btn btn-outline-secondary btn-sm">Usta</button></a> 
<!--  < < -->
          </div>
      ...
      <?php
        ...
        $id = $xml->xpath("//porady/porada[@kategoria='$kategoria' and @podkategoria='".$podkategoria."']/@id");
                ...
                <?php
                    ...
                    echo '<div class="card">
                            <div class="card-header" id="heading'.$i.'">
                                <h5 class="mb-0">
                                    <button id="id'.$id[$i].'" class="btn btn-link" data-toggle="collapse" data-target="#collapse'.$i.'" aria-expanded="true" aria-controls="collapse'.$i.'">'.$tytul[$i].'</button>
                                </h5>
                            </div>
