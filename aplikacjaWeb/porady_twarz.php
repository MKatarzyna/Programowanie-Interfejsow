...
<main role="main">
        ...
        <section class="jumbotron text-center">
          <div class="container">
            <h1 class="jumbotron-heading">Porady / Twarz</h1>
            ...
            <div class="row">
                ...
                <div class="card mb-4 box-shadow">
                  ...
                  <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                      <div class="btn-group">
                        <a  href="porady_twarz_brwi.php"><button type="button" class="btn btn-sm btn-outline-secondary">Wybierz</button></a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-md-6">
                <div class="card mb-4 box-shadow">
                  ...
                  <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                      <div class="btn-group">
                        <a href="porady_twarz_rzesy.php"><button type="button" class="btn btn-sm btn-outline-secondary">Wybierz</button></a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-md-6">
                <div class="card mb-4 box-shadow">
                  ...
                  <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                      <div class="btn-group">
                        <a href="porady_twarz_usta.php"><button type="button" class="btn btn-sm btn-outline-secondary">Wybierz</button></a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-md-6">
                <div class="card mb-4 box-shadow">
                  ...
                  <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                      <div class="btn-group">
                        <a href="porady_twarz_maseczki.php"><button type="button" class="btn btn-sm btn-outline-secondary">Wybierz</button></a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-md-6">
                <div class="card mb-4 box-shadow">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="btn-group">
                        <a href="porady_twarz_peelingi.php"><button type="button" class="btn btn-sm btn-outline-secondary">Wybierz</button></a>
                        </div>
                    </div>
                    </div>
                </div>
                ...
                <div class="card mb-4 box-shadow">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="btn-group">
                        <a href="porady_twarz_kapielParowa.php"><button type="button" class="btn btn-sm btn-outline-secondary">Wybierz</button></a>
                        </div>
                    </div>
                    </div>
                </div>
