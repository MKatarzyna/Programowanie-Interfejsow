        ...
        <div class="container">
            <script type="text/javascript">
                ...
                function computeBMI() {
                    ...
                    if (output < 16)
                        document.getElementById("comment").innerText = "Wygłodzenie";
                        ...
                        document.getElementById("comment").innerText = "I stopień otyłości";
                    else if (output >= 35 && output <= 39.99)
                        document.getElementById("comment").innerText = "II stopień otyłości";
                    else if (output > 40)
                        document.getElementById("comment").innerText = "Otyłość skrajna";
                }
            </script>
            ...
            <body  class="naglowek">
                ...
                <div class="mb-5">
                    <h2 class="jumbotron-heading text-muted">Kalkulator "<b>B</b>ody <b>M</b>ass <b>I</b>ndex"</h2>
                </div>
                <div class="lead text-muted mb-5">
                    <p>Podaj swój wzrost: <input type="text" id="height"/> [cm]</p>
                    <p>Podaj swoją wagę: <input type="text" id="weight"/> [kg]</p>
                    <input class="lead text-muted" type="submit" value="Oblicz BMI" onclick="computeBMI();">
                </div>
                <div class="mb-5">
                    <h3 class="jumbotron-heading  text-muted">Twoje BMI wynosi: <span id="output">?</span></h3>
                    <h3 class="jumbotron-heading text-muted">To oznacza, że masz: <span id="comment"> ?</span> </h3>
                </div>
