...
<main role="main">
        ...
        <section class="jumbotron text-center">
          <div class="container">
            <h1 class="jumbotron-heading"> Maseczki  </h1>
            ...
            <a href="porady.php"><button type="button" class="btn btn-outline-secondary btn-sm">Porady</button></a> &gt; 
                ...
                <a href="porady_twarz_maseczki.php"><button type="button" class="btn btn-outline-secondary btn-sm">Maseczki</button></a> 
<!--  < < -->
          </div>
